                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input name="name_ar" value={{ $product['name_ar'] }} type="text"
                                    class="form-control @error('name_ar') is-invalid @enderror" id="exampleInputEmail1"
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input name="name_en" value={{ $product['name_en'] }} type="text"
                                    class="form-control @error('name_en') is-invalid @enderror" id="exampleInputEmail1"
                                    placeholder="Enter Product Name">
                                @error('name_en')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
